...
[Check deployed version here](https://stripe-integration-two.vercel.app/)
...
Source: https://www.youtube.com/watch?v=4mOkFXyxfsU&t=11725s

In case you want to run this project follow the below steps-
Configuring Sanity
install sanity cli globally
sanity init inside the project folder
run sanity start
documentation cmd - sanity docs
manager - sanity manage
inside sanity project - sanity init, sanity login
on successfull sanity project: sanity start
on localhost:3333 you will have sanity project running
on sanity.io a new project will be created based on the name provided during sanity init.
inside this project under API - create a viewer key.
Add this key in react env file. check sample env for details.
Change projectId as per sanity project
Note: Add content in sanity before running the nextjs app.
